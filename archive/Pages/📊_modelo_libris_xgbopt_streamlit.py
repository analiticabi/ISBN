# -*- coding: utf-8 -*-
"""
Created on Wed May 29 17:30:36 2024
...
pickle_in = open("C:/Users/hpalacios/Downloads/archive/predict.pkl", 'rb') 
classifier = pickle.load(pickle_in) 

#########Configurar etiqueta de la página web#################

st.set_page_config(page_title="Modelo XGB Optimizado Demo", page_icon="📈")
...
st.sidebar.header("📈 XGB Optimizado Demo")
